...
public class GradingSystem {
    ...
    protected String genero[] = { "m", "f" };
    protected String lineaMatriz[];
    protected double matriz[][];
    protected int deficiente = 0;
    protected double si = 0, no = 0;
    protected int siF = 0, siM = 0, noM = 0, noF = 0;
    protected String m, f, generoMejor;
    protected String destacadoMath = "";
    protected Map<Double, String>  dic = new HashMap<Double, String>();
