...
public class S14_LogInController {
    ...
    void login(ActionEvent event) throws IOException {
        ...
        if (error.isEmpty()){
            FXMLLoader vistaInicio = new FXMLLoader(getClass().getResource("Vista/S14_inicio.fxml"));
            Parent root = vistaInicio.load();
            S14_InicioController driver = vistaInicio.getController();
