...
public class S16_LogInController {
    ...
    void login(ActionEvent event) throws IOException {
        ...
        if (error.isEmpty()){
            FXMLLoader vistaInicio = new FXMLLoader(getClass().getResource("Vista/S16_inicio.fxml"));
            Parent root = vistaInicio.load();
            S16_InicioController driver = vistaInicio.getController();
